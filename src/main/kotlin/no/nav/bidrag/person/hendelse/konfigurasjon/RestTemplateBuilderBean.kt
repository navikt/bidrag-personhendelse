...
import no.nav.bidrag.commons.web.config.INaisProxyCustomizer
import no.nav.bidrag.commons.web.config.NaisProxyCustomizer
...
class RestTemplateBuilderBean {
    ...
    fun restTemplateBuilder(
        ...
        .additionalCustomizers(iNaisProxyCustomizer, observationRestTemplateCustomizer)
