...
@Configuration
@Import(RestTemplateBuilderBean::class, TokenClientInterceptor::class, ServiceUserAuthTokenInterceptor::class)
class RestOperationsAzure {
    ...
    fun restOperationsJwtBearer(
        ...
        tokenClientInterceptor: TokenClientInterceptor
    ) = restTemplateBuilder.additionalInterceptors(tokenClientInterceptor).build()
